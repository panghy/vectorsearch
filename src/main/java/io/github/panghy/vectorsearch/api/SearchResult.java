 ...
 *
 * @param segmentId Segment identifier containing the vector.
 * @param vectorId  Segment-local vector identifier.
 ...
 */
@Builder
public record SearchResult(int segmentId, int vectorId, double score, double distance, byte[] payload) {}
